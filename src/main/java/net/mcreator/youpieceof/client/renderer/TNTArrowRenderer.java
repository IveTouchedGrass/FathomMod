...
import net.mcreator.youpieceof.entity.TNTArrowEntity;
...
public class TNTArrowRenderer extends EntityRenderer<TNTArrowEntity> {
	...
	private final Modeltnt_arrow_Converted model;

	public TNTArrowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modeltnt_arrow_Converted(context.bakeLayer(Modeltnt_arrow_Converted.LAYER_LOCATION));
	}
